...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(
        @Value("${pickple.jwt.access-token.secret}") String accessTokenSecret,
        @Value("${pickple.jwt.access-token.expiration-ms}") int accessTokenExpirationMs,
        @Value("${pickple.jwt.refresh-token.secret}") String refreshTokenSecret,
        @Value("${pickple.jwt.refresh-token.expiration-ms}") int refreshTokenExpirationMs)
    ...
    public String generateAccessToken(PickpleUserDetails userDetails) throws JOSEException {
        return generateToken(userDetails, accessTokenExpirationMs, accessTokenSigner, "access");
    }

    public String generateRefreshToken(PickpleUserDetails userDetails) throws JOSEException {
        return generateToken(userDetails, refreshTokenExpirationMs, refreshTokenSigner, "refresh");
    }

    private String generateToken(PickpleUserDetails userDetails, int expirationMs, JWSSigner signer,
